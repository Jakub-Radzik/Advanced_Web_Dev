import { Badge, Box, Button, Flex, Image, Paper, Rating, ScrollArea,Text } from "@mantine/core";
...
export const Repertoire = () => {
  ...
  return (
            ...
            >
             <h2>{movie.title}</h2>
              ...
              <Flex pos={'absolute'} bottom={10}>
                <Button size={'xl'} color={"dark"} onClick={()=>handleDrawer(movie)}>
                  <Text>Kup bilet</Text>
                </Button>
              </Flex>
            </Paper>
    ...
    <DetailsDrawer opened={drawerOpen} movie={movie} onClose={()=>setDrawerOpen(false)}/>
    </>
  );
};
